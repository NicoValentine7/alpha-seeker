...
.th-tip {{ display: none; position: absolute; top: calc(100% + 12px); left: 50%; transform: translateX(-50%); z-index: 100; background: #21262d; border: 1px solid #3d444d; border-radius: 12px; padding: 20px 24px; min-width: 360px; max-width: 400px; box-shadow: 0 16px 48px rgba(0,0,0,0.5); white-space: normal; text-transform: none; letter-spacing: normal; font-weight: 400; line-height: 1.8; }}
.th-tip::before {{ content: ''; position: absolute; top: -6px; left: 50%; transform: translateX(-50%) rotate(45deg); width: 12px; height: 12px; background: #21262d; border-left: 1px solid #3d444d; border-top: 1px solid #3d444d; }}
thead th:hover .th-tip {{ display: block; }}
.th-tip .tip-top, .th-tip .tip-bottom {{ display: contents; }}
.th-tip .tip-title {{ font-weight: 700; font-size: 15px; color: #f0f6fc; margin-bottom: 12px; }}
.th-tip .tip-simple {{ font-size: 14px; color: #e6edf3; margin-bottom: 16px; padding: 12px 14px; background: #161b22; border-radius: 6px; border-left: 3px solid #58a6ff; }}
.th-tip .tip-detail {{ font-size: 12px; color: #8b949e; line-height: 1.9; }}
