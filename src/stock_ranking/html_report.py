...
.th-tip {{ display: none; position: absolute; top: 100%; left: 0; z-index: 100; background: #1c2128; border: 1px solid #30363d; border-radius: 6px; padding: 10px 12px; min-width: 260px; max-width: 340px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); white-space: normal; text-transform: none; letter-spacing: normal; font-weight: 400; line-height: 1.5; }}
thead th:hover .th-tip {{ display: block; }}
.th-tip .tip-title {{ font-weight: 600; font-size: 12px; color: #f0f6fc; margin-bottom: 4px; }}
.th-tip .tip-simple {{ font-size: 12px; color: #c9d1d9; margin-bottom: 6px; }}
.th-tip .tip-detail {{ font-size: 11px; color: #8b949e; border-top: 1px solid #30363d; padding-top: 6px; }}
